...
import { reducer as lotteryReducer, State as LotteryState } from './lottery.reducer';

import { reducer as userTicketReducer, State as UserTicketState } from './user-ticket.reducer';

import { reducer as lotteryDrawsReducer, State as lotteryDrawsState } from './lottery-draws.reducer';
